...
export default function Main(){
    return (
        <>
         <main className="flex flex-cols items-center mt-16 w-full">
             <div className="mx-4 max-w-4xl">
                 ...
                 <div className="flex flex-cols sm:flex-row">
                     <div className="sm:w-1/3">
                         <div className="bg-white flex flex-cols items-center rounded-lg p-8 border-b-4 border-gray-500">
