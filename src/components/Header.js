              ...
              <div className="mt-4 flex relative ">
                 <Reveal effect="fadeInUp">
                  <div >
                      <a 
                      href="#" 
                      className="bg-pink-600 transition scale-75 animate-pulse translate-x-4 skew-y-3 duration-300 animate-spin ease-linear hover:bg-pink-400 text-indigo-100 font-bold uppercase text-xs font-sans rounded-full mt-2 py-2 px-4"
                      >
                      Enroll Now
                    </a>
                 </div>
                  ...
                  <div 
                   className="absolute right-0 bg-white rounded-full  flex justify-center items-center p-5 border-4 border-gray-500">
                      <svg 
