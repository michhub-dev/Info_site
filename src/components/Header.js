    ...
    <>
      <header className="bg-purple-600 px-4 py-3 w-screen border-b-4 border-gray-500 flex justify-center">
        <div className="w-full max-w-4xl ">
          ...
          <div className="my-4">
              <h1 className="text-indigo-100 font-sans text-bold text-2xl">What are you interested in learning?</h1>
              <p className="text-gray-100 font-sans text-sm">Choose from the long list of courses available on this platform</p>
