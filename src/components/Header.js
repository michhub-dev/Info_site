      ...
      <header className="bg-purple-600 px-4 py-3 w-screen border-b-4 border-gray-500 flex justify-center">
        <div className="w-full max-w-4xl ">
          ...
          <div className="my-4">
              ...
              <p className="text-gray-100 text-sm">Choose from the long list of courses available on this platform</p>
              
              <div className="mt-4 flex relative ">
                  <div >
                      <a href="#" className="bg-pink-600 transition scale-75 animate-pulse translate-x-4 skew-y-3 duration-300 animate-spin ease-linear hover:bg-pink-400 text-indigo-100 font-bold uppercase text-xs rounded-full mt-2 py-2 px-4">Enroll Now</a>
                  </div>
